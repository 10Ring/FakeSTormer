...
if __name__ == '__main__':
    ...
    if extract_landmark:
        ...
        if save_aligned:
            ...
            for i, img_p in enumerate(tqdm(img_paths, dynamic_ncols=True)):
                ...
                os.makedirs(f'{lm_ins.image_root}{lm_ins.compression}/{lm_ins.split}/{lm_ins.data_type}/aligned_{lm_ins.fake_types[0]}_{cfg.PREPROCESSING.N_LANDMARKS}/{vid_id}', exist_ok=True)
    ...
    if args.file_path is None:
        ...
        try:
            lm_ins.save2json(data, fn=f'{lm_ins.split}_{lm_ins.dataset}_{lm_ins.data_type}_{cfg.PREPROCESSING.N_LANDMARKS}.json')
        except Exception as e:
            print(e)
