...
def dynamic_blend(source, target, mask, **kwargs):
    mask_blured, size_h, size_w, kernel_1, kernel_2, sigma_rand = get_blend_mask(mask, **kwargs)
...
def get_blend_mask(mask, **kwargs): 
    ...
    return mask_blured.reshape((mask_blured.shape+(1,))), size_h, size_w, kernel_1, kernel_2, sigma_rand
