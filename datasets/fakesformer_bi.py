...
from package_utils.utils import vis_heatmap, draw_landmarks
...
if __name__=="__main__":
    ...
    for b, batch_data in enumerate(hm_ff_loader):
        inputs, labels, heatmaps = \
            batch_data["img"], batch_data['label'], batch_data['heatmap']
        print(f'X.shape - {inputs.shape}, y shape - {labels.shape}, heatmaps - {heatmaps.shape}')
        break
